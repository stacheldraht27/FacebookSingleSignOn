...
public class GooglePlus extends Activity implements View.OnClickListener, ConnectionCallbacks, OnConnectionFailedListener {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.get_data_button:
                ...
                if (mGoogleApiClient.isConnected()) {
                    get_data_dialog = new Dialog(GooglePlus.this);
                    get_data_dialog.setContentView(R.layout.fragment_user_profile);
            ...
            case R.id.post_button:
                if (mGoogleApiClient.isConnected()) {
                    ...
                    Intent shareIntent = new PlusShare.Builder(GooglePlus.this)
                            .setType("text/plain")
